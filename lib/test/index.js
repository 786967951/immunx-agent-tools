...
var runBlock = function (sensor, block) {
    var txns = [];
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    ...
                    _c = [findings];
                    return [4 /*yield*/, sensor.handleBlock(block)];
                case 1:
                ...
                case 2:
                    ...
                    _g = [findings];
                    return [4 /*yield*/, sensor.handleTransaction(tx)];
                case 3:
...
var generalTestFindingGenerator = function () {
    ...
    return immunx_agent_1.Finding.fromObject({
        name: "Finding Test",
        description: "Finding for test",
        alertId: "TEST",
        severity: immunx_agent_1.FindingSeverity.Low,
        type: immunx_agent_1.FindingType.Info,
    });
};
