...
import { Finding, BlockEvent, HandleBlock, HandleTransaction, TransactionEvent } from "immunx-agent";
export interface Bot {
    handleTransaction: HandleTransaction;
    handleBlock: HandleBlock;
}
export declare const runBlock: (sensor: Bot, block: BlockEvent, ...txns: TransactionEvent[]) => Promise<Finding[]>;
