...
var TestTransactionEvent = /** @class */ (function (_super) {
    ...
    function TestTransactionEvent() {
        ...
        var block = {};
        return _super.call(this, immunx_agent_1.EventType.BLOCK, immunx_agent_1.Network.MAINNET, transaction, [], {}, block, [], null) || this;
    }
    ...
    TestTransactionEvent.prototype.addEventLog = function (event, address, inputs) {
        ...
        var iface = new immunx_agent_1.ethers.utils.Interface([event]);
        var eventFragment = immunx_agent_1.ethers.utils.EventFragment.from(immunx_agent_1.ethers.utils.Fragment.from(event));
    ...
    TestTransactionEvent.prototype.addTraces = function () {
        ...
        var toTrace = function (props) {
            ...
            var functionFragment = immunx_agent_1.ethers.utils.FunctionFragment.from(immunx_agent_1.ethers.utils.Fragment.from(props.function));
            var iface = new immunx_agent_1.ethers.utils.Interface([functionFragment]);
            return {
                action: {
...
}(immunx_agent_1.TransactionEvent));
