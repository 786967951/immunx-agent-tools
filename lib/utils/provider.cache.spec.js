    ...
    ExtendedMockEthersProvider.prototype._getTransactionRequest = function (transaction) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _getTransactionRequest = immunx_agent_1.ethers.providers.BaseProvider.prototype._getTransactionRequest.bind({
                            formatter: immunx_agent_1.ethers.providers.BaseProvider.getFormatter(),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _getBlockTag = immunx_agent_1.ethers.providers.BaseProvider.prototype._getBlockTag.bind({
                            formatter: immunx_agent_1.ethers.providers.BaseProvider.getFormatter(),
                            pollingInterval: 0,
...
var cacheKey = function (to, data, blockTag, cacheByBlockTag) {
    var block = cacheByBlockTag ? immunx_agent_1.ethers.utils.hexValue(blockTag).slice(2) : "";
...
var TEST_IFACE = new immunx_agent_1.ethers.utils.Interface([
    "function test1()",
...
describe("ProviderCache tests suite", function () {
    ...
    var addCalls = function (test2Param, test3Return, test4Param, test4Return, blockTag) {
        ...
        mockProvider.addCallTo(TEST_ADDRESS, blockTag, TEST_IFACE, "test2", {
            inputs: [immunx_agent_1.ethers.BigNumber.from(test2Param)],
            outputs: [],
        });
        mockProvider.addCallTo(TEST_ADDRESS, blockTag, TEST_IFACE, "test3", {
            inputs: [],
            outputs: [immunx_agent_1.ethers.BigNumber.from(test3Return)],
        });
        mockProvider.addCallTo(TEST_ADDRESS, blockTag, TEST_IFACE, "test4", {
            inputs: [immunx_agent_1.ethers.BigNumber.from(test4Param)],
            outputs: [immunx_agent_1.ethers.BigNumber.from(test4Return)],
        });
        return [
            {
            ...
            {
                data: TEST_IFACE.encodeFunctionData("test2", [immunx_agent_1.ethers.BigNumber.from(test2Param)]),
                result: TEST_IFACE.encodeFunctionResult("test2", []),
            },
            {
                data: TEST_IFACE.encodeFunctionData("test3", []),
                result: TEST_IFACE.encodeFunctionResult("test3", [immunx_agent_1.ethers.BigNumber.from(test3Return)]),
            },
            {
                data: TEST_IFACE.encodeFunctionData("test4", [immunx_agent_1.ethers.BigNumber.from(test4Param)]),
                result: TEST_IFACE.encodeFunctionResult("test4", [immunx_agent_1.ethers.BigNumber.from(test4Return)]),
            },
        ];
    };
    beforeAll(function () {
    ...
    it("should proxy properties from the original provider and return a modified version of call()", function () {
        var provider = new immunx_agent_1.ethers.providers.JsonRpcProvider("test", 1);
