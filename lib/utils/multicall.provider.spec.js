...
describe("MulticallProvider test suite", function () {
    var MULTICALL_IFACE = new immunx_agent_1.ethers.utils.Interface(multicall_provider_1.MULTICALL2_ABI);
    ...
    var TEST_IFACE = new immunx_agent_1.ethers.utils.Interface(TEST_ABI);
    ...
    var TEST_CALLS = [
        contract.func1(),
        contract.func2(),
        contract.func3(immunx_agent_1.ethers.BigNumber.from(5)),
        contract.func4((0, _1.createAddress)("0xb1")),
    ];
    var TEST_OUTPUTS = TEST_CALLS.map(function (call) { return immunx_agent_1.ethers.BigNumber.from(immunx_agent_1.ethers.utils.formatBytes32String(call.name)); });
