                    ...
                    traceCalls = new trace_calls_1.default({
                        onFinding: function (metadata) {
                            return immunx_agent_1.Finding.fromObject({
                                ...
                                alertId: "Test Id",
                                severity: immunx_agent_1.FindingSeverity.Medium,
                                type: immunx_agent_1.FindingType.Suspicious,
                                metadata: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    traceCalls = new trace_calls_1.default({
                        onFinding: test_1.generalTestFindingGenerator,
                        signatures: [immunx_agent_1.ethers.utils.Fragment.from(functionDefinition).format("full")],
                        from: from,
                        to: to,
                        filterByArguments: filterByArguments,
                    });
